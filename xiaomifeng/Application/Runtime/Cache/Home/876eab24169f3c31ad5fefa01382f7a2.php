...
<title>幽默笑话大全_爆笑笑话_笑破你的肚子的搞笑段子 - 糗事百科
</title>
...
<link href="http://static.qiushibaike.com/css/dist/web/app.min.css?v=501d0a0056b219ba2cf18444379b841f" media="screen, projection" rel="stylesheet" type="text/css"/>
<script type="text/javascript">
// Baqsidu Automatic push content
var _hmt = _hmt || [];
(function() {
var hm = document.createElement("script");
hm.src = "https://hm.baqsidu.com/hm.js?2670efbdd59c7e3ed3749b458cafaa37";
...
<div class="navbox clearfix">
  <ul class="nav">
    <li class="first cur"><h1><a href="<?php echo U('Index/index');?>">首  页</a></h1></li>
...
<a  href="<?php echo U('Index/kaiixn');?>" rel="nofollow">首页</a>
<a  href="<?php echo U('Index/qs');?>">趣闻</a>
<a  href="<?php echo U('Index/doutu');?>">趣图</a>
...
<div class="logout">
<a href="<?php echo U('Index/login');?>" class="fn-signin-required logintop" id='logintop' rel="nofollow" style="font-size:16.5px;">登录</a>
</div>
</div>
</div>
</div> -->
...
<div class="content-block clearfix" style="margin-left:300px;">
...
<div class="article block untagged mb15" qsid='qiushi_tag_118036535'>

<div class="author clearfix">
<!-- <span><img src="/static/images/thumb/anony.png?v=b61e7f5162d14b7c0d5f419cd6649c87" alt="匿名用户"/></span> -->
<span><h2><?php echo ($v["zuozhe"]); ?></h2></span>
</div>



<a href="<?php echo U('index/qsxq');?>?qsid=<?php echo ($v["qsid"]); ?>" target="_blank" class='contentHerf' >
<div>



<span><?php echo ($v["qstext"]); ?></span>
...
<div class="stats">
<span class="stats-vote"><i class="number"><?php echo ($v["qslike"]); ?></i> 好笑</span>
<span class="stats-comments">


<span class="dash"> · </span>
<a href="/article/118036535" data-share="/article/118036535" qsid="c-118036535" class="qiushi_comments" target="_blank">
<i class="number"><?php echo ($v["qscomment"]); ?></i> 评论
</a>

<a href="<?php echo U('Index/xiazai');?>?qsid=<?php echo ($v["qsid"]); ?>"><span>下载</span></a>

</span>
</div>
<div qsid="qiushi_counts_118036535" class="stats-buttons bar clearfix">
<ul class="clearfix">
<li qsid="vote-up-118036535" class="up">
<a href="javascript:voting(118036535,1)" class="voting" data-article="118036535" qsid="up-118036535" rel="nofollow">
<i></i>
<span class="number hidden">2161</span>
</a>
</li>
<li qsid="vote-dn-118036535" class="down">
<a href="javascript:voting(118036535,-1)" class="voting" data-article="118036535" qsid="dn-118036535" rel="nofollow">
<i></i>
<span class="number hidden">-33</span>
</a>
</li>

<li class="comments">
<a href="/article/118036535" qsid="c-118036535" class="qiushi_comments" target="_blank">
<i></i>
</a>
</li>
...
<?php echo ($str); ?><!-- 当前为<?php echo ($page); ?>页 -->
     ...
     function fun(page){
        ...
        ajax.onreadystatechange=function(){
            if(ajax.readyState==4){
                document.getElementById('tt').innerHTML=ajax.responseText;
            }
        }
        //ajax.open('get',"<?php echo U('Opus/opus_con');?>page="+page);
        ajax.open('get',"<?php echo U('Index/qs');?>?page="+page);
        ajax.send();
    }tu
...
<!-- 16-糗事百科首页底部_BTF_728x90 -->
<ins class="adsbygoogle"
style="display:inline-block;wqsidth:728px;height:90px"
...
<ul>
<li>
<a href="http://shang.qq.com/wpa/qunwpa?qsidkey=da34d190ca97a0b21d64ebc6f3ab72c076ed35820e629b78fcf9f6a78f7063cd"
target="_blank" rel="external nofollow">
网站反馈群
</a>
</li>
...
<div class="signin-box" qsid="login-form">
<div class="sigin-left">
<div class="signin-account clearfix">
<h4 class="social-signin-heading">社交帐号登录</h4>
<a rel="external nofollow" oauth_href href="https://open.weixin.qq.com/connect/qrconnect?appqsid=wx559af2d26b56c655&redirect_uri=http%3A%2F%2Fwww.qiushibaike.com%2Fnew4%2Fsession%3Fsrc%3Dwx&response_type=code&scope=snsapi_login#wechat_redirect" class="social-btn social-wechat">
使用 微信 账号</a>
<a rel="external nofollow" oauth_href href="https://api.weibo.com/oauth2/authorize?client_qsid=63372306&redirect_uri=http%3A%2F%2Fwww.qiushibaike.com%2Fnew4%2Fsession" class="social-btn social-weibo">
使用 微博 账号</a>
<a rel="external nofollow" oauth_href href="https://graph.qq.com/oauth2.0/authorize?which=Login&display=pc&client_qsid=100251437&response_type=code&redirect_uri=www.qiushibaike.com/new4/session?src=qq" class="social-btn social-qq">
使用 QQ 账号 </a>
</div>
<div class="signin-form clearfix">
<h4 class="social-signin-heading">糗事百科账号登录</h4>
<form method="post" action="/new4/session">
<input type="hqsidden" name="_xsrf" value="2|9a824ce1|d9b7f9cdd9d153c1d88604e2e6bbfe8a|1479897000"/>
...
<input type="checkbox" qsid="remember_me" name="remember_me" checked="" value="checked" style="display:none">
</div>
<div class="signin-error" qsid="signin-error"></div>
<button type="submit" qsid="form-submit" class="form-submit">登录</button>
</form>
</div>
...
<script type="text/javascript" src="http://static.qiushibaike.com/js/dist/web/app.min.js?v=1992842dca39240be70a7c748de59d1c"></script>
