...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Index/Index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">广告管理</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): foreach($list as $key=>$li): ?><tr id="k_<?php echo ($li["nav_id"]); ?>">
                            <td class="tc"><input name="id[]" value="<?php echo ($li["nav_id"]); ?>" type="checkbox"></td>
                            <td><?php echo ($li["nav_id"]); ?></td>
                            <td><?php echo ($li["nav_name"]); ?></td>
                            <td><?php echo ($li["nav_href"]); ?></td>
                            <td><?php echo ($li["username"]); ?></td>
                            <td><img class="nav_img" src="/xiaomifeng/Public/<?php echo ($li["nav_image"]); ?>" alt="" height="100px" width="100px"></td>
                            <td><img class="nav_img" src="/xiaomifeng/Public/<?php echo ($li["nav_img"]); ?>" alt="" height="50px" width="50px"></td>
                            <td><?php echo ($li["nav_starttime"]); ?></td>
                            <td><?php echo ($li["nav_endtime"]); ?></td>
                            <td>
                                <?php if($li["nav_status"] == '0'): ?>显示
                                <?php else: ?>
                                    不显示<?php endif; ?>
                            </td>
                            <td><?php echo ($li["nav_limit"]); ?></td>
                            <td><?php echo ($li["width_width"]); ?>px</td>
                            <td><?php echo ($li["width_light"]); ?>px</td>
                            <td>
                                <?php if($li["width_main"] == '0'): ?>上部
                            <?php else: ?>
                                下部<?php endif; ?>
                            </td>    
                            <td>
                                <!-- <a class="link-update" href="#">修改</a> -->
                                <a class="link-del" href="javascript:void(0)" id="<?php echo ($li["nav_id"]); ?>">删除</a>
                            </td>
